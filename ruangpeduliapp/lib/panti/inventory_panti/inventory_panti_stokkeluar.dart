...
class StokKeluarScreen extends StatelessWidget {
  const StokKeluarScreen({super.key});

  @override
  Widget build(BuildContext context) => const StokKeluarDetailScreen();
}
...
// ═══════════════════════════════════════════════════════════════════════════════
// STOK KELUAR DETAIL SCREEN
// ═══════════════════════════════════════════════════════════════════════════════

class StokKeluarDetailScreen extends StatefulWidget {
  final String title;

  const StokKeluarDetailScreen({
    super.key,
    this.title = 'Stok Keluar',
  });

  @override
  State<StokKeluarDetailScreen> createState() => _StokKeluarDetailScreenState();
}

class _StokKeluarDetailScreenState extends State<StokKeluarDetailScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
              ...
              itemBuilder: (context, index) {
                ...
                return _KategoriTile(
                  ...
                  onTap: () => Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => StokKeluarDetailKategoriScreen(kategori: _items[index]),
                    ),
                  ),
                );
              },
          ...
          Padding(
            ...
            child: Center(
              child: ElevatedButton.icon(
                ...
                label: const Text('Tambahkan Kategori', style: TextStyle(fontWeight: FontWeight.w600)),
      ...
      floatingActionButton: FloatingActionButton(
        ...
        backgroundColor: _isEditMode ? Colors.white : kPink,
        elevation: 4,
        shape: const CircleBorder(),
        child: Icon(
          Icons.edit_outlined,
          color: _isEditMode ? kPinkDark : Colors.white,
          size: 22,
        ),
      ),
    );
...
class _ConfirmDeleteDialog extends StatelessWidget {
  ...
  const _ConfirmDeleteDialog({required this.onHapus, required this.onBatal});
...
class StokKeluarDetailKategoriScreen extends StatelessWidget {
  final _KategoriItem kategori;

  const StokKeluarDetailKategoriScreen({super.key, required this.kategori});
